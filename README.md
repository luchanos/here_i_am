...
<p>
    ...
    Типовая задача: мы должны получать и обрабатывать события от другого сервиса. На python писался consumer и sender, 
    а в RMQ создавалась очередь (при необходимости exchange) в которую посылались сообщения.
